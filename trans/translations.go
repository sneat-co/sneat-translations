...
🌍 atau secara publik (<i>siapa saja yang memiliki tautan dapat menerimanya, Anda dapat membatalkannya kapan saja</i>)`,
	...
	InviteToJoinFamilySpace: {
		"en-UK": "Invite to join family space",
		"ru-RU": "Пригласить присоединиться к семейному пространству",
		"es-ES": "Invitar a unirse al espacio familiar",
		"fa-IR": "دعوت برای پیوستن به فضای خانوادگی",
		"it-IT": "Invita a unirsi allo spazio familiare",
		"de-DE": "Einladen, dem Familienbereich beizutreten",
		"fr-FR": "Inviter à rejoindre l'espace familial",
		"pl-PL": "Zaproś do dołączenia do przestrzeni rodzinnej",
		"pt-PT": "Convidar para entrar no espaço familiar",
		"ko-KO": "가족 공간에 참여 초대",
		"ja-JP": "ファミリースペースに招待",
		"zh-CN": "邀请加入家庭空间",
		"ua-UA": "Запросити доєднатися до сімейного простору",
		"pt-BR": "Convidar para participar do espaço familiar",
		"tr-TR": "Aile alanına katılmaya davet et",
		"id-ID": "Undang untuk bergabung dengan ruang keluarga",
	},
	BackToContacts: {
