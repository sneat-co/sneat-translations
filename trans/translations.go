...
如果您认为这是一个错误，请在 @DebtsTrackerGroup 中告诉我们。`,
	...
	MESSAGE_TEXT_OK_PLEASE_TRY_AGAIN: {
		...
		"fr-FR": "Ok, veuillez réessayer.",
		"id-ID": "Ok, silakan coba lagi.",
		"it-IT": "Ok, prova di nuovo.",
		"ja-JP": "はい、もう一度お試しください。",
		"ko-KO": "네, 다시 시도해 주세요.",
		"pl-PL": "Ok, spróbuj ponownie.",
		"pt-BR": "Ok, tente novamente.",
		"pt-PT": "Ok, tente novamente.",
		"ru-RU": "Хорошо, попробуйте ещё раз.",
		"tr-TR": "Tamam, lütfen tekrar deneyin.",
		"ua-UA": "Добре, спробуйте ще раз.",
		"uz-UZ": "Mayli, qaytadan urinib ko'ring.",
		"zh-CN": "好的，请再试一次。",
	},
	...
	MESSAGE_TEXT_YOUR_BILL_SPLITTING_GROUPS: {
		...
		"fr-FR": "Vos groupes de partage de factures",
		"id-ID": "Grup pembagian tagihan Anda",
		"it-IT": "Sei già membro di questo gruppo di divisione fatture.", // TODO(IT) verify
		"ja-JP": "あなたの請求書分割グループ",
		"ko-KO": "귀하의 청구서 분할 그룹",
		"pl-PL": "Twoje grupy dzielenia rachunków",
		"pt-BR": "Seus grupos de divisão de contas",
		"pt-PT": "Seus grupos de divisão de contas",
		"ru-RU": "Ваши группы совметсной оплаты",
		"tr-TR": "Fatura bölme gruplarınız",
		"ua-UA": "Ваші групи спільної оплати",
		"uz-UZ": "Hisob-kitoblarni bo'lish guruhlari",
		"zh-CN": "您的账单分割组",
	},
...
%v`,
	...
	UserHasNotJoinedSpaceYet: {
		...
		"en-US": "This contact has not joined this space yet.",
		...
		"pt-PT": "Este contacto ainda não aderiu a este espaço.",
	...
	UserHasNotJoinedFamilySpaceYet: {
		...
		"en-US": "Has not joined this family space yet.",
		...
		"pt-PT": "Ainda não aderiu a este espaço familiar.",
