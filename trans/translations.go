...
但您也可以从提供的列表中进行选择。`},
	...
	YouAreSubscribedToNActivity: {
		arEG: "لقد اشتركت في أنشطة %s.",
		deDE: "Sie sind für %s Aktivitäten angemeldet.",
		enUK: "You are subscribed to %s activities.",
		esES: "Estás suscrito a %s actividades.",
		faIR: "شما در %s فعالیت مشترک هستید.",
		frFR: "Vous êtes abonné à %s activités.",
		idID: "Anda berlangganan %s aktivitas.",
		itIT: "Sei iscritto a %s attività.",
		jaJP: "%s のアクティビティを購読しています。",
		koKR: "%s개의 활동을 구독하고 있습니다.",
		plPL: "Jesteś subskrybentem %s aktywności.",
		ptBR: "Você está inscrito em %s atividades.",
		ptPT: "Está inscrito em %s atividades.",
		ruRU: "Вы подписаны на %s категори(и/й).",
		trTR: "%s etkinliğine abonesiniz.",
		ukUA: "Ви підписані на %s активностей.",
		uzUZ: "Siz %s faoliyatiga obuna boʻldingiz.",
		zhCN: "您已订阅 %s 活动。"},
